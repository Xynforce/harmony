            ...
            while(keepGoing) {
                ...
                switch(cm.getType()) {
                    ...
                    case ChatMessage.LOGOUT:
                        ...
                        writeMsgObj(new ChatMessage(1, username+" has logged out of the server."));
                        if (sg !=null){
                    ...
                    case ChatMessage.USERLIST:
                        ...
                        writeMsgObj(new ChatMessage(1,"Current users connected at " + sdf.format(new Date()) + "\n"));
                        for(int i = 0; i < al.size(); ++i) {
                            ClientThread ct = al.get(i);
                            writeMsgObj(new ChatMessage(1, (i+1) + ") " + ct.username + " live since " + ct.date));
                        }
